...
import iest.edu.androidwear.databinding.ActivityRelojBinding
...
class MainActivity : Activity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvSaludo.text = "HOLA MUNDO"
        ...
        binding.bnCambio.setOnClickListener {
            ...
            alerta.setTitle("Atencion").setMessage("Quiere mandar saludo $textoSeleccionado").setCancelable(false).setPositiveButton("Ok",DialogInterface.OnClickListener{dialogInterface, i ->  binding.tvSaludo.text = textoSeleccionado  })
                .setNegativeButton("Cancelar",DialogInterface.OnClickListener{
                        dialogInterface, i -> Toast.makeText(this,"Una lastima:'(", Toast.LENGTH_SHORT).show()
